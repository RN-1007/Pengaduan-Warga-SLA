...
import { CreateUserModal } from '@/modules/admin/components/create-user-modal'
...
export default function AdminUsersPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6 flex flex-col min-h-screen">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between gap-3 mb-6">
